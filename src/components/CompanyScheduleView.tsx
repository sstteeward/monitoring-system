...
const CompanyScheduleView: React.FC = () => {
  ...
  const calendarAction = async (action: 'connect'|'import'|'sync'|'disconnect', scheduleId?: string) => {
