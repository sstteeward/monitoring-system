                        ...
                        <div className="glass-card fade-in" style={card}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div>
                                    ...
                                    <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>Receive alerts when students submit documents.</div>
                                </div>
                            ...
                            <div style={row}>
                                <div>
                                    ...
                                    <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>Get desktop alerts for pending approvals.</div>
                                </div>
