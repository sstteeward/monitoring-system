                                            ...
                                            <div className="account-dropdown">
                                                ...
                                                {settingsExpanded && (
                                                    <div className="account-dropdown-submenu">
                                                        ...
                                                        <div className="account-dropdown-subitem" onClick={() => { setShowAccountMenu(false); setSettingsExpanded(false); navigateTo('settings', { tab: 'appearance' }); }}>
                                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" /></svg>
                                                            <span>Appearance</span>
                                                        </div>
                                                        <div className="account-dropdown-subitem" onClick={() => { setShowAccountMenu(false); setSettingsExpanded(false); navigateTo('settings', { tab: 'notifications' }); }}>
                                                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg>
                                                            <span>Notifications</span>
                                                        </div>
                                                        <div className="account-dropdown-subitem" onClick={() => { setShowAccountMenu(false); setSettingsExpanded(false); navigateTo('settings', { tab: 'security' }); }}>
                    ...
                    <div style={{
                        ...
                        <div className="glass-card" style={{
                            ...
                            <div style={{ display: 'flex', gap: '0.75rem' }}>
                                ...
                                <button
                                    onClick={async () => { await supabase.auth.signOut(); routerNavigate('/', { replace: true }); }}
