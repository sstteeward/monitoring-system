...
import CoordinatorEvaluationsView from './CoordinatorEvaluationsView';
...
type View = 'overview' | 'companies' | 'company-accounts' | 'advisers' | 'students' | 'grades' | 'approvals' | 'requirements' | 'evaluations' | 'attendance' | 'announcement' | 'departments' | 'security' | 'profile' | 'settings';
...
const CoordinatorDashboard: React.FC = () => {
    ...
    const navigateTo = (view: View, param?: any) => {
        ...
        routerNavigate((view === 'overview' ? '/coordinator' : `/coordinator/${view}`) + query);
