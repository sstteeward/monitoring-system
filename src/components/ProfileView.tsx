                        ...
                        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '1.25rem', marginBottom: '1.25rem' }}>
                            ...
                            <div className="profile-academic-grid">
                                ...
                                <div style={{ gridColumn: '1 / -1', marginTop: '0.5rem' }}>
                                    ...
                                    <div style={{ 
                                        ...inputStyle, 
                                        background: profile?.grade ? 'rgba(16, 185, 129, 0.05)' : 'var(--bg-elevated)', 
                                        color: profile?.grade ? '#10b981' : 'var(--text-muted)', 
                                        fontWeight: profile?.grade ? 700 : 400,
                                        border: profile?.grade ? '1px solid rgba(16, 185, 129, 0.3)' : '1px solid var(--border)',
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: '0.5rem'
                                    }}>
                                    ...
                                    <p style={{ fontSize: '0.72rem', color: 'var(--text-muted)', marginTop: '0.35rem' }}>Only you and your coordinator can see your final grade.</p>
                                </div>
                            </div>
                        </div>
