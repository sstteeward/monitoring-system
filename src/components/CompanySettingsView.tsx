...
const CompanySettingsView: React.FC<CompanySettingsViewProps> = ({ sidebarMode, setSidebarMode }) => {
        ...
        <div className="view-container fade-in">
            <div className="view-header">
                <div>
                    ...
                    <p className="view-subtitle">Customize your company account preferences</p>
                </div>
            </div>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                    {(['expanded', 'collapsed', 'hover'] as const).map(mode => (
                                        <button
                                            ...
                                            style={{
                                                flex: 1, padding: '1.1rem 1rem', borderRadius: 14, cursor: sidebarMode === mode ? 'default' : 'pointer',
                                                fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: '0.88rem', transition: 'all .25s',
                                                ...
                                                textTransform: 'capitalize', minWidth: '120px'
                                            }}
                                        >
                        ...
                        <div className="glass-card fade-in" style={card}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div>
                                    ...
                                    <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>Receive alerts when interns submit documents.</div>
                                </div>
                    ...
                    {activeTab === 'about' && (
                        <div className="glass-card fade-in" style={card}>
                            ...
                            <div style={{ marginTop: '1.25rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.75rem' }}>
                                    <button className="btn btn-secondary" onClick={() => setShowTerms(true)} style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem' }}>
                                        Terms & Conditions
                                    </button>
                                    <button className="btn btn-secondary" onClick={() => setShowPrivacy(true)} style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem' }}>
                                        Privacy Policy
                                    </button>
                                </div>
                            </div>
