        ...
        <div className={`dashboard-container ${collapsed ? 'sidebar-collapsed' : ''}`}>
            ...
            <aside className="sidebar">
                ...
                <div className="sidebar-header">
                    ...
                    <button className="sidebar-toggle-btn" onClick={toggleSidebar} title={collapsed ? "Expand sidebar" : "Collapse sidebar"}>
                        {collapsed ? (
                ...
                <div className="sidebar-scrollable">
                    ...
                    <nav className="sidebar-nav">
                        <div className="sidebar-nav-item active" title="Dashboard">
                        ...
                        <div className="sidebar-nav-item" title="Timesheets">
                        ...
                        <div className="sidebar-nav-item" title="Reports">
                    ...
                    <nav className="sidebar-nav">
                        <div className="sidebar-nav-item" title="Profile">
                        ...
                        <div className="sidebar-nav-item" title="Settings">
